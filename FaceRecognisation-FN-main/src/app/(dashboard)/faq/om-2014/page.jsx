...
export default function OM2014Page() {

  const manuals = [
    {
      id: 1,
      title: "OM dated 21.11.2014",
      file: "/om-dated.pdf",
      uploadDate: "2014-11-21",
    },
    {
      id: 2,
      title: "OM Clarification Circular 2014",
      file: "/OM_Clarification_2014.pdf",
      uploadDate: "2014-12-05",
    },
  ];
    ...
    <div className="p-6">
      ...
      <div className="mb-6">
        ...
        <p className="mt-2 max-w-3xl text-sm text-gray-600">
          This section contains official Office Memorandums (OM) issued
          in November 2014 regarding biometric attendance and employee
          governance. Documents may be viewed or downloaded.
        </p>
      </div>
