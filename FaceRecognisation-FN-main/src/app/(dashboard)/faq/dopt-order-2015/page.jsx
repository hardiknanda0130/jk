...
export default function DoptOrderPage() {

  const manuals = [
    {
      id: 1,
      title: "DoPT Order Dated 22.06.2015",
      file: "/Dopt-order Dated.pdf",
      uploadDate: "2015-06-22",
    },
    {
      id: 2,
      title: "DoPT Clarification Circular 2015",
      file: "/Dopt_Clarification_2015.pdf",
    ...
    <div className="p-6">
      ...
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-900">
          DoPT Order Dated 22.06.2015
        </h1>

        <p className="mt-2 max-w-3xl text-sm text-gray-600">
          This section contains official DoPT circulars and orders related
          to biometric attendance and employee governance issued in 2015.
          Documents can be viewed online or downloaded for reference.
        </p>
      </div>
