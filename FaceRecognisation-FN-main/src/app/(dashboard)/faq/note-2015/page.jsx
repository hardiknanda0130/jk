...
export default function Note2015Page() {

  const manuals = [
    {
      id: 1,
      title: "Note dated 02.06.2015",
      file: "/note-dated.pdf",
      uploadDate: "2015-06-02",
    },
    {
      id: 2,
      title: "Clarification Note 2015",
      file: "/Note_Clarification_2015.pdf",
    ...
    <div className="p-6">
      ...
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-900">
          Note dated 02.06.2015
        </h1>

        <p className="mt-2 max-w-3xl text-sm text-gray-600">
          This section contains official notes and clarifications issued
          in June 2015 related to biometric attendance and governance.
          Documents may be viewed online or downloaded for reference.
        </p>
      </div>
