...
export default function DashboardDeviceInstallationPage() {

  const manuals = [
    {
      id: 1,
      title: "Dashboard Device Installation Guide",
      file: "/DashboardDevice_Installation.pdf",
      uploadDate: "2026-06-12",
    },
    {
      id: 2,
      title: "Device Setup Troubleshooting",
      file: "/Device_troubleshooting.pdf",
    ...
    <div className="p-6">
      ...
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-900">
          Dashboard Device Installation
        </h1>

        <p className="mt-2 max-w-3xl text-sm text-gray-600">
          This section contains official installation manuals and setup
          guides for desktop biometric devices. You can view or download
